 ...
 */
@FunctionalInterface
public interface CalculateCRC extends Function<byte[], byte[]> {
    /**
     * Gets the main instance of this class.
     *
     * @return A singleton instance of this class.
     */
    public static CalculateCRC getInstance() {
        if (CalculateCRC.Implementation.instance == null)
            CalculateCRC.Implementation.instance = new CalculateCRC.Implementation();
        return CalculateCRC.Implementation.instance;
    }

    public static class Implementation implements CalculateCRC {
        private static CalculateCRC instance = null;
        ...
        private static final int[] crcTable = new int[] { 0x00000000, 0x77073096, 0xee0e612c, 0x990951ba, 0x076dc419,
